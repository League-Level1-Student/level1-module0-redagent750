...
if(guess.equalsIgnoreCase("arnold")) {
	...
	JOptionPane.showMessageDialog(null,"You are wrong! That person is Arnold.");
}
showNextImage();
...
if(guess2.equalsIgnoreCase("leonardo")) {
	...
	JOptionPane.showMessageDialog(null,"You are wrong! That person is Leonardo.");
}
showNextImage();
...
showNextImage();
JOptionPane.showMessageDialog(null,"Score: " + scoreCounter);
